...
class ListeDemandeCarnetCheque extends React.Component {
            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    <View style={{ flexDirection: "row", alignItems: "center", marginTop: "5%" }}>
                        ...
                        <Text style={{ color: "#27277A", fontWeight: "bold", fontSize: 24, textAlign: "center",width:"80%"  }}>Liste des demandes de carnet de chèque</Text>
...
export default ListeDemandeCarnetCheque;
