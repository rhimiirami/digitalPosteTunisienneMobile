            ...
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    <ScrollView>
                        ...
                        <View style={{
                            ...
                            >aymen-daraji1990@gmail.com</TextInput>
                ...
                <View style={styles.footer}>
                    ...
                    >
                        ...
                        }}>{this.state.busyClick ? "S'il vous plaît, attendez ..." : "Modifier"}</Text>
                    </TouchableOpacity>
                </View >
            </View >
        );
